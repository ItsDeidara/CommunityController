...
def execute_command(message: str) -> None:
    ...
    if len(split_message) <= MAX_COMMANDS_PER_MESSAGE:
        for single in split_message:
            ...
            # A, B, X, and Y
            if single in ["A", "B", "X", "YAMIDISABLED"]:
            ...
            elif single in ["HOLD_ADISABLEDDONTUSEME", "HOLD_BDISABLEDDONTUSEME", "HOLD_XDISABLEDDONTUSEME", "HOLD_YAMIDISABLED"]:
                if single == "HOLD_ADISABLEDDONTUSEME":
                    increment_button_count("A")
                    controller.hold_buttons(BUTTON_A)
                    sleep(1.0)
                    controller.release_buttons(BUTTON_A)
                elif single == "HOLD_BDISABLEDDONTUSEME":
                    increment_button_count("B")
                    controller.hold_buttons(BUTTON_B)
                    sleep(1.0)
                    controller.release_buttons(BUTTON_B)
                elif single == "HOLD_XDISABLEDDONTUSEME":
                    increment_button_count("X")
                    controller.hold_buttons(BUTTON_X)
                    sleep(1.0)
                    controller.release_buttons(BUTTON_X)
                elif single == "HOLD_YAMIDISABLED":
                    increment_button_count("Y")
                    controller.hold_buttons(BUTTON_Y)
                    sleep(1.0)
                    controller.release_buttons(BUTTON_Y)
                command_executed = True
            elif single in ["HOLD_LDISABLEDDONTUSEME", "HOLD_LBDISABLEDDONTUSEME", "HOLD_RDISABLEDDONTUSEME", "HOLD_RBDISABLEDDONTUSEME", "HOLD_ZLDISABLEDDONTUSEME", "HOLD_LTDISABLEDDONTUSEME", "HOLD_ZRDISABLEDDONTUSEME", "HOLD_RTDISABLEDDONTUSEME", "HOLD_LCLICKDISABLEDDONTUSEME", "HOLD_L3DISABLEDDONTUSEME", "HOLD_RCLICKDISABLEDDONTUSEME", "HOLD_R3DISABLEDDONTUSEME"]:
                if single in ["HOLD_LDISABLEDDONTUSEME", "HOLD_LBDISABLEDDONTUSEME"]:
                    increment_button_count("L")
                    controller.hold_buttons(BUTTON_L)
                    sleep(1.0)
                    controller.release_buttons(BUTTON_L)
                elif single in ["HOLD_RDISABLEDDONTUSEME", "HOLD_RBDISABLEDDONTUSEME"]:
                    increment_button_count("R")
                    controller.hold_buttons(BUTTON_R)
                    sleep(1.0)
                    controller.release_buttons(BUTTON_R)
                elif single in ["HOLD_ZLDISABLEDDONTUSEME", "HOLD_LTDISABLEDDONTUSEME"]:
                    increment_button_count("ZL")
                    controller.hold_buttons(BUTTON_ZL)
                    sleep(1.0)
                    controller.release_buttons(BUTTON_ZL)
                elif single in ["HOLD_ZRDISABLEDDONTUSEME", "HOLD_RTDISABLEDDONTUSEME"]:
                    increment_button_count("ZR")
                    controller.hold_buttons(BUTTON_ZR)
                    sleep(1.0)
                    controller.release_buttons(BUTTON_ZR)
                elif single in ["HOLD_LCLICKDISABLEDDONTUSEME", "HOLD_L3DISABLEDDONTUSEME"]:
                    increment_button_count("LCLICK")
                    controller.hold_buttons(BUTTON_LCLICK)
                    sleep(1.0)
                    controller.release_buttons(BUTTON_LCLICK)
                elif single in ["HOLD_RCLICKDISABLEDDONTUSEME", "HOLD_R3DISABLEDDONTUSEME"]:
                    increment_button_count("RCLICK")
                    controller.hold_buttons(BUTTON_RCLICK)
                    sleep(1.0)
                    controller.release_buttons(BUTTON_RCLICK)
                command_executed = True
            elif single in ["HOLD_UPDISABLEDDONTUSEME", "HOLD_DOWNDISABLEDDONTUSEME", "HOLD_LEFTDISABLEDDONTUSEME", "HOLD_RIGHTDISABLEDDONTUSEME"]:
                if single == "HOLD_UPDISABLEDDONTUSEME":
                    increment_button_count("UP")
                    controller.hold_dpad(DPAD_UP)
                    sleep(1.0)
                    controller.release_dpad()
                elif single == "HOLD_DOWNDISABLEDDONTUSEME":
                    increment_button_count("DOWN")
                    controller.hold_dpad(DPAD_DOWN)
                    sleep(1.0)
                    controller.release_dpad()
                elif single == "HOLD_LEFTDISABLEDDONTUSEME":
                    increment_button_count("LEFT")
                    controller.hold_dpad(DPAD_LEFT)
                    sleep(1.0)
                    controller.release_dpad()
                elif single == "HOLD_RIGHTDISABLEDDONTUSEME":
            ...
            elif single in ["KEEP_HOLD_ADISABLEDDONTUSEME", "KEEP_HOLD_BDISABLEDDONTUSEME", "KEEP_HOLD_XDISABLEDDONTUSEME", "KEEP_HOLD_YDISABLEDDONTUSEME"]:
                if single == "KEEP_HOLD_ADISABLEDDONTUSEME":
                    increment_button_count("A")
                    controller.hold_buttons(BUTTON_A)
                elif single == "KEEP_HOLD_BDISABLEDDONTUSEME":
                    increment_button_count("B")
                    controller.hold_buttons(BUTTON_B)
                elif single == "KEEP_HOLD_XDISABLEDDONTUSEME":
                    increment_button_count("X")
                    controller.hold_buttons(BUTTON_X)
                elif single == "KEEP_HOLD_YDISABLEDDONTUSEME":
                    increment_button_count("Y")
                    controller.hold_buttons(BUTTON_Y)
                command_executed = True
            elif single in ["RELEASE_ADISABLEDDONTUSEME", "RELEASE_BDISABLEDDONTUSEME", "RELEASE_XDISABLEDDONTUSEME", "RELEASE_YDISABLEDDONTUSEME"]:
                if single == "RELEASE_ADISABLEDDONTUSEME":
                    controller.release_buttons(BUTTON_A)
                elif single == "RELEASE_BDISABLEDDONTUSEME":
                    controller.release_buttons(BUTTON_B)
                elif single == "RELEASE_XDISABLEDDONTUSEME":
                    controller.release_buttons(BUTTON_X)
                elif single == "RELEASE_YDISABLEDDONTUSEME":
                    controller.release_buttons(BUTTON_Y)
                command_executed = True
            elif single in ["KEEP_HOLD_LDISABLEDDONTUSEME", "KEEP_HOLD_LBDISABLEDDONTUSEME", "KEEP_HOLD_RDISABLEDDONTUSEME", "KEEP_HOLD_RBDISABLEDDONTUSEME", "KEEP_HOLD_ZLDISABLEDDONTUSEME", "KEEP_HOLD_LTDISABLEDDONTUSEME", "KEEP_HOLD_ZRDISABLEDDONTUSEME", "KEEP_HOLD_RTDISABLEDDONTUSEME"]:
                if single in ["KEEP_HOLD_LDISABLEDDONTUSEME", "KEEP_HOLD_LBDISABLEDDONTUSEME"]:
                    increment_button_count("L")
                    controller.hold_buttons(BUTTON_L)
                elif single in ["KEEP_HOLD_RDISABLEDDONTUSEME", "KEEP_HOLD_RBDISABLEDDONTUSEME"]:
                    increment_button_count("R")
                    controller.hold_buttons(BUTTON_R)
                elif single in ["KEEP_HOLD_ZLDISABLEDDONTUSEME", "KEEP_HOLD_LTDISABLEDDONTUSEME"]:
                    increment_button_count("ZL")
                    controller.hold_buttons(BUTTON_ZL)
                elif single in ["KEEP_HOLD_ZRDISABLEDDONTUSEME", "KEEP_HOLD_RTDISABLEDDONTUSEME"]:
                    increment_button_count("ZR")
                    controller.hold_buttons(BUTTON_ZR)
                command_executed = True
            elif single in ["RELEASE_LDISABLEDDONTUSEME", "RELEASE_LBDISABLEDDONTUSEME", "RELEASE_RDISABLEDDONTUSEME", "RELEASE_RBDISABLEDDONTUSEME", "RELEASE_ZLDISABLEDDONTUSEME", "RELEASE_LTDISABLEDDONTUSEME", "RELEASE_ZRDISABLEDDONTUSEME", "RELEASE_RTDISABLEDDONTUSEME"]:
                if single in ["RELEASE_LDISABLEDDONTUSEME", "RELEASE_LBDISABLEDDONTUSEME"]:
                    controller.release_buttons(BUTTON_L)
                elif single in ["RELEASE_RDISABLEDDONTUSEME", "RELEASE_RBDISABLEDDONTUSEME"]:
                    controller.release_buttons(BUTTON_R)
                elif single in ["RELEASE_ZLDISABLEDDONTUSEME", "RELEASE_LTDISABLEDDONTUSEME"]:
                    controller.release_buttons(BUTTON_ZL)
                elif single in ["RELEASE_ZRDISABLEDDONTUSEME", "RELEASE_RTDISABLEDDONTUSEME"]:
                    controller.release_buttons(BUTTON_ZR)
                command_executed = True
            elif single in ["KEEP_HOLD_UPDISABLEDDONTUSEME", "KEEP_HOLD_DOWNDISABLEDDONTUSEME", "KEEP_HOLD_LEFTDISABLEDDONTUSEME", "KEEP_HOLD_RIGHTDISABLEDDONTUSEME"]:
                if single == "KEEP_HOLD_UPDISABLEDDONTUSEME":
                    increment_button_count("UP")
                    controller.hold_dpad(DPAD_UP)
                elif single == "KEEP_HOLD_DOWNDISABLEDDONTUSEME":
                    increment_button_count("DOWN")
                    controller.hold_dpad(DPAD_DOWN)
                elif single == "KEEP_HOLD_LEFTDISABLEDDONTUSEME":
                    increment_button_count("LEFT")
                    controller.hold_dpad(DPAD_LEFT)
                elif single == "KEEP_HOLD_RIGHTDISABLEDDONTUSEME":
                    increment_button_count("RIGHT")
                    controller.hold_dpad(DPAD_RIGHT)
                command_executed = True
            elif single in ["RELEASE_DPADDISABLEDDONTUSEME", "RELEASE_UPDISABLEDDONTUSEME", "RELEASE_DOWNDISABLEDDONTUSEME", "RELEASE_LEFTDISABLEDDONTUSEME", "RELEASE_RIGHTDISABLEDDONTUSEME"]:
                controller.release_dpad()
                command_executed = True
            #game sensitive
